            ...
            <div class="col-md-10">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-item-center pt-2 pb-2">
                        ...
                        <a href="{{ asset('/video/video-product-category.mp4') }}" target="blank"
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <button id="submit-excel" type="button" class="btn btn-primary" data-url="{{ route('import.product-category.post') }}">
...
@section('js')
    ...
    <script src="{{ asset('js/import-product-category.js') }}"></script>
@endsection
